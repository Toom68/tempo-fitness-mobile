                ...
                {ex.sets.map((set, setIndex) => (
                  <div key={setIndex} className="grid grid-cols-[1.5rem_1fr_1fr_2.25rem] items-center gap-2">
                    ...
                    <button
                      ...
                      className={`flex h-10 w-9 items-center justify-center rounded-md transition-colors active:scale-95 ${
                        set.completed
                    ...
                    {ex.sets.length > 1 && (
                      <button
                        ...
                        className="col-start-4 -mt-1 justify-self-end text-destructive active:scale-95"
                      >
